...
val make_let_fn_defn : id -> id list -> expr -> defn
(** [make_let_fn_defn f xs e] represents [let f (xs) = e] *)
...
val make_let_fn : id -> id list -> expr -> expr -> expr
(** [make_let_fn f xs e1 e2] represents [let f (xs) = e1 in e2] *)

val make_ref : expr -> expr
(** [make_ref e] represents [ref e] *)

val make_deref : expr -> expr
(** [make_deref e] represents [!e] *)

val make_assign : expr -> expr -> expr
(** [make_assign e1 e2] represents [e1 := e2] *)
...
(** [make_int i] represents the integer [i] *)
...
(** [make_update_field e1 e2 e3] represents [e1\[e2\] <- e3] *)
